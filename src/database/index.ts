...
import { DemandServiceDetails } from '../modules/demand/entities/DemandServiceDetails';
...
const AppDataSource = new DataSource({
  ...
  migrations: [],
  entities: [User, Demand, Service, Reports, Client, UserTokens, DemandServiceDetails],
  logging: false,
})
